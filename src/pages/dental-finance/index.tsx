      ...
      >
        <div>
          ...
          <p className="pl-4 pr-0 lg:pr-4 text-lg sm:text-2xl text-teal">
            ...
            perhaps dental implants, we&apos;ll help bring your new smile to
            life. Beauty <br />
            begins here, with{" "}
          ...
          <div className="flex items-center justify-center pt-12">
            <div className="flex items-center justify-center">
              <div className="relative flex">
                <input
                  type="email"
                  placeholder="Find a dental partner near me"
                  style={{ width: "26rem" }}
            ...
            <div className="flex flex-col md:flex-row items-start justify-center md:gap-56 lg:gap-72 sm:gap-4">
              <div className="flex flex-col items-start mb-4 md:mb-0 text-black">
                ...
                <div className="text-left ml-2 text-black">
                  <p>
                    <span className="underline">Check online</span> to see if
                    you qualify for a <br />
              ...
              <div className="flex flex-col items-start mb-4 md:mb-0">
                ...
                <div className="text-left ml-2 text-black">
                  <p>
                    Fin Flexi Loans offers you low-interest, <br></br>flexible
                    and afforable finance
                  </p>
                </div>
              </div>
              <div className="flex flex-col items-start">
