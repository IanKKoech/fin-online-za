    ...
    <label>
      ...
      <div className="relative flex items-center">
        <select
          required={required}
          className={cn(
            "w-full appearance-none rounded border border-gray-100 py-3 px-5 placeholder:text-gray-200 focus:border-gray-100 focus:outline-0 focus:ring focus:ring-primary focus:ring-offset-2 2xl:py-4",
            className
          )}
          {...rest}
        >
